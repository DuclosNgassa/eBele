...
public class FeedImageView extends ImageView
{
	...
	/**
	 * Resource ID of the image to be used as a placeholder
	 * until the network image is loaded
	 */
	private int mDefaultImageId;
	
	/**
	 * Resource ID of the image to be used if the network
	 * response fails
	 */
	...
	/**
	 * Sets the default image resource ID to be used for this view
	 * until the attempt to load it completes
	 */
	...
	private void loadImageIfNecessary(final boolean isInLayoutPass)
	{
        ...
        // requests and clear the currently loaded image.
   		...
   		//if there was an old request in this view, 
   		//check if it need to be canceled.
   		if(mImageContainer != null && mImageContainer.getRequestUrl() != null)
   		{
   			if(mImageContainer.getRequestUrl().equals(mUrl))
   			{
   				//if the request is fom the same url return
   				return;
   			}
   			else
   			{
